...
\bnfprod{reducer}{\bnfts{array} \bnfor \bnfts{sum} \bnfor \bnfts{count} \bnfor \bnfts{max} \bnfor \bnfts{min} \bnfor \bnfts{last} \bnfor \bnfts{first}} \\
\bnfprod{bin-op}{\bnfts{get} \bnfor \bnfts{apply} \bnfor \bnfts{plus} \bnfor \bnfts{minus} \bnfor \bnfts{times} \bnfor \bnfts{div} \bnfor \bnfts{fdiv} \bnfor \bnfts{mod} \bnfor \bnfts{keyval}} \\
...
\bnfprod{query}{\bnfpn{arg} \bnfor \bnfpn{reducer}\bnfts{(}\bnfpn{arg}\bnfts{)}
\bnfor \bnfpn{bin-op}\bnfts{(} \bnfpn{arg} \bnfts{,} \bnfpn{arg} \bnfts{)}
...
Now, let's explore a selection of tensor computations that can be performed using \lang{}.
